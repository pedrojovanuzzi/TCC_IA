...
export const Footer = () => {
  return (
    <div>
        ...
        <div className="border-t border-transparent pb-8 pt-20 sm:pt-24">
          ...
          <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
            ...
            <p className="mt-8 text-sm/6 text-gray-600 md:order-1 md:mt-0">
              &copy; 2025 Faculdades Integradas de Bauru, Pedro Artur Jovanuzzi, Higor Costa Rissato. All Rights Reserved
            </p>
          </div>
        </div>
      </footer>

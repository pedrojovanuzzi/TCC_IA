...
export default function Video() {
  ...
  const handleUpload = async (file) => {
    ...
    try {
      // envia para inferir e criptografar
      ...
      if (response.data.video_url) {
        // extrai nome do arquivo criptografado
        const filename = response.data.video_url.split("/").pop();
        // busca descriptografado
        ...
        {processedVideo && (
          <div className="mt-6 flex justify-center flex-col items-center">
            ...
            <video
              key={processedVideo}
              controls
              className="mt-2 w-2/3 rounded-lg shadow-md"
              src={processedVideo}
            />
            <a
              href={processedVideo}

            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
              <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                ...
                <p className="mt-6 text-xl/8 text-gray-600">
                  Nosso modelo é capaz de distinguir, o humano do objeto, se por exemplo, um técnico retirar seu capacete, uma caixa
                  vermelha irá aparecer detectando a ausencia dele, isso também serve para luvas e sapatos
                </p>
                <p className="mt-6 text-base/7 text-gray-600">
                  Outros objetos também são detectados, porem não soltam alerta caso não estejam usando, como, cintos de escalar e botas
                </p>
              </div>
